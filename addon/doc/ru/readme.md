...
* Control+Alt+T в окне Studio: объявить оставшееся время для воспроизводимой в данный момент дорожки, голосовой дорожки или корзины.
* NVDA+Shift+F12 из окна Studio: объявляет время вещания, например, за 5 минут до начала часа. При двойном нажатии этой команды будут объявлены минуты и секунды до начала часа.
* Alt+NVDA+1 из окна Studio: открывает категорию сигналов тревоги в диалоге конфигурации дополнения Studio (не поддерживает речь по требованию).
...
* Alt+NVDA+0 из локальной и удалённой Studio, Creator, Remote VT, и Track Tool: Открывает диалог настроек дополнения Studio (не поддерживает речь по требованию).
