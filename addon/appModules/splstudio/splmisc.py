	...
	def onOk(self, evt):
		...
		if user32.FindWindowW("SPLStudio", None):
			...
			while obj is not None:
				...
				obj = obj.next
			if obj is not None:
				# Set focus once, as do action method on tracks will set focus twice.
				obj.setFocus()
...
def metadataList():
	...
	# 21.03/20.09.6-LTS: make sure None is not included in metadata list, otherwise it results in no metadata data for streams.
