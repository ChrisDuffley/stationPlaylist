...
* In encoders and Streamer, NVDA will no longer appear to do nothing or play error tones when NVDA is exited while focused on something other than encoders list without focusing to encoders first.
